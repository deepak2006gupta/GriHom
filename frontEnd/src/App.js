      ...
      <div className="App">
        ...
        <main className="main-content">
          <Routes>
              ...
              element={
                user ? (
                  ...
                  <LoginRequiredAlert
                    ...
                    description="Please sign in to generate your personalized GriHom report."
                    onLoginClick={openLogin}
                  />
                )
              } 
            ...
            <Route 
              ...
              element={
                user ? (
                  ...
                  <LoginRequiredAlert
                    title="Login Required for Dashboard"
            ...
            {/* ⚠️ Admin routes disabled for now */}
            <Route path="/admin" element={<HomePage />} />
            <Route path="/admin/suggestions" element={<HomePage />} />
